...
app.get('/createtables',(req, res)=>{
  ...
  db.serialize(function(e){
    ...
    */
    ...
    ///db.run("CREATE TABLE IF NOT EXISTS TICKETS (ID INTEGER PRIMARY KEY AUTOINCREMENT,TICKET_NAME TEXT,TICKET_MESSAGE TEXT,TICKET_TYPE INTEGER,UPDATED_AT DATE NOT NULL ON CONFLICT REPLACE DEFAULT (datetime('now','localtime')),CREATED_AT DATE NOT NULL ON CONFLICT REPLACE DEFAULT (datetime('now','localtime')))");
    db.run("CREATE TABLE IF NOT EXISTS TICKETS (ID INTEGER PRIMARY KEY AUTOINCREMENT,TICKET_NAME TEXT,TICKET_MESSAGE TEXT,TICKET_TYPE INTEGER,UPDATED_AT TEXT NOT NULL ON CONFLICT REPLACE DEFAULT (DATETIME('now', 'localtime')),CREATED_AT TEXT NOT NULL ON CONFLICT REPLACE DEFAULT (DATETIME('now', 'localtime')))");
